...
class Porownywarka: 
    ...
    def wyswietl_porownywarke(self):
        st.header("Porownywarka województw")
        st.write("Wybierz dwa województwa i dowiedz się, w którym zyje się lepiej!")
        ...
        st.subheader(f"Pojedynek: {woj_1} vs {woj_2} (Dane za {rok_ostatni})")
        ...
        st.info(f"**Werdykt:** Mimo różnic w cenach, większą siłę nabywczą mają mieszkańcy województwa **{lepie_m}**.")
